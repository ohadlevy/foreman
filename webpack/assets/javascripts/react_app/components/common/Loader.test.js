...
describe('Loader', () => {
  describe('renders correct content based on status', () => {
    ...
    it('pending', () => {
      ...
      expect(wrapper.children().length).toBe(1);
      expect(
        wrapper.children().equals(<div className="spinner spinner-lg" />)
      ).toBe(true);
    });
    ...
    it('pending-different-spinner', () => {
      ...
      expect(wrapper.children().length).toBe(1);
      expect(
        wrapper.children().equals(<div className="spinner spinner-xs" />)
      ).toBe(true);
    });
    ...
    it('default case', () => {
      ...
      expect(
        wrapper.children().children().at(0).is('.pficon.pficon-error-circle-o')
      ).toBe(true);
